...
namespace Dapper.Client
{
    ...
    public partial interface IDbClient
    {
        ...
        Task<dynamic> QueryFirstAsync(string sql, object param = null,  CommandType? commandType = null);
        ...
        Task<dynamic> QuerySingleAsync(string sql, object param = null,  CommandType? commandType = null);
