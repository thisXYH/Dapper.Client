...
namespace Dapper.Client
{
    public partial interface IDbClient
    {
        ...
        /// </returns>
        IEnumerable<object> List(Type type, string sql, object param = null, bool buffered = true, int? commandTimeout = null, CommandType? commandType = null);
        ...
        /// </returns>
        IEnumerable<T> List<T>(string sql, object param = null, bool buffered = true, int? commandTimeout = null, CommandType? commandType = null);
        ...
        /// </returns>
        T Get<T>(string sql, object param = null, int? commandTimeout = null, CommandType? commandType = null);
        ...
        dynamic Get(string sql, object param = null, int? commandTimeout = null, CommandType? commandType = null);
